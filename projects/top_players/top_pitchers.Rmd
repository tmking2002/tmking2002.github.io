...
```{r, include=FALSE}
box <- load_ncaa_softball_playerbox(season = 2023, category = "Pitching")
...
DT::datatable(pitcher_stats_upd, 
              colnames=c("Team", "Player", "IP", "W", "L", "wFIP", "ERA", "SO Rate", "BB Rate"),
              options = list(pageLength = 25)) %>%
  formatPercentage(c("SOr", "BBr"), digits = 1) %>% 
  formatRound(columns = c("wFIP", "ERA"),
              digits = 3)
```
